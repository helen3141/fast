...
export function mapMixedCombinatorTypes(syntax: string): string {
    ...
    const firstCombinatorType: CombinatorType = mapCombinatorType(syntax);
    const combinatorSplitString: string = getCombinatorSplitString(firstCombinatorType);
    let mixedCombinatorTypes: string = syntax;
    let syntaxSplitByCombinatorType: string[] = syntax.split(combinatorSplitString);
